...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        sections = [
            ...
            {"exam": "Свободные разделы", "subject": "Английский язык", "section": "Чтение", "exam_code": "FREE", "has_fixed_structure": False, "default_question_count": 20, "time_to_complete": 60},
        ...
        for section_data in sections:
            try:
                ...
                if not Section.objects.filter(
                    ...
                    new_section = Section.objects.create(**section_data)

                    # Автоматически создаём типы вопросов
                    for i in range(1, new_section.default_question_count + 1):
                        QuestionType.objects.create(section=new_section, position=i, name=f"Type {i}")
